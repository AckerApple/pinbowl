...
export class Tag {
    ...
    buildBeforeElement(insertBefore, options = {
        ...
        interpolateElement(temporary, context, this, { forceElement: options.forceElement });
...
function updateExistingValue(existing, value, tag) {
    ...
    if (isTagComponent(tempResult)) {
        ...
        const tagSupport = tempResult.tagSupport || oldTagSetup || getTagSupport(tempResult);
